...
abstract ZipFile({fileName:String, targetName:String}) from {fileName:String, targetName:String} {
    @:from static function fromString(file):ZipFile return {fileName: file, targetName: file}
}

class ReleaseHaxelib {
    static var outPath = "haxelib.zip";
    static var files:Array<ZipFile> = ["haxelib.json", "src-api", "LICENSE.md", {fileName: "README-haxelib.md", targetName: "README.md"}];
