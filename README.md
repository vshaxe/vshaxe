...
leveraging the [Haxe Language Server](https://github.com/vshaxe/haxe-language-server). It works best with [Haxe 4.0.0-rc.3](https://haxe.org/download/version/4.0.0-rc.2/), but supports any Haxe version starting from 3.4.0.
